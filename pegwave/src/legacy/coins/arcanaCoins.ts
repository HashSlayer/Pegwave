import type { ArcanaCoin } from './coinTypes.ts';

const ARCANA_CARDS: ReadonlyArray<ArcanaCoin> = [
  {
    type: 'arcana',
    id: 'arcana_fool',
    name: 'The Fool',
    description: 'Create the last Tarot or Planet Plinko used',
  ...
  },
  {
    ...
    id: 'arcana_magician',
    name: 'The Magician',
    description: 'Enhance 1 selected card into a Lucky Coin',
  ...
  },
  {
    ...
    description: 'Creates up to 2 random Planet Plinkos',
    effect: { type: 'createPlanetPlinko' },
  },
  {
    type: 'arcana',
    id: 'arcana_empress',
  ...
  },
  {
    ...
    id: 'arcana_lovers',
    name: 'The Lovers',
    description: 'Enhance 1 selected card into a Wild Coin',
  ...
  },
  {
    ...
    id: 'arcana_chariot',
    name: 'The Chariot',
    description: 'Enhance 1 selected card into a Steel Coin',
    effect: { type: 'enhanceHand', enhancement: 'foil', count: 1 },
  },
  {
    type: 'arcana',
    id: 'arcana_justice',
    name: 'Justice',
    description: 'Enhance 1 selected card into a Glass Coin',
  ...
  },
  {
    ...
    id: 'arcana_devil',
    name: 'The Devil',
    description: 'Enhance 1 selected card into a Gold Coin',
    effect: { type: 'enhanceHand', enhancement: 'foil', count: 1 },
  },
  {
    type: 'arcana',
    id: 'arcana_tower',
    name: 'The Tower',
    description: 'Enhance 1 selected card into a Stone Coin',
    effect: { type: 'enhanceHand', enhancement: 'foil', count: 1 },
  },
  {
    type: 'arcana',
...
export function getRandomArcanaCoins(count: number): ReadonlyArray<ArcanaCoin> {
