...
describe('card', () => {
  ...
  describe('card comparisons', () => {
    test('isSameSuit', () => {
      const card1 = createCoin('♥', 'A');
      const card2 = createCoin('♥', 'K');
      const card3 = createCoin('♠', 'A');
    ...
    test('isSameRank', () => {
      const card1 = createCoin('♥', 'A');
      const card2 = createCoin('♠', 'A');
      const card3 = createCoin('♥', 'K');
