...
import { Coin as CoinComponent } from './Coin.tsx';
import { SUITS, RANKS } from './coin.ts';

interface CoinViewerProps {
  readonly deck: ReadonlyArray<Coin>;
  readonly isOpen: boolean;
  readonly onClose: () => void;
}

export function CoinViewer({ deck, isOpen, onClose }: CoinViewerProps): React.ReactElement | null {
  ...
  const cardsBySuit = new Map<string, Coin[]>();
  const cardsByRank = new Map<string, Coin[]>();
  const enhancedCards: Coin[] = [];
