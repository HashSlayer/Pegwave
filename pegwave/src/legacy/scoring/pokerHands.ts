import type { Coin, Rank, Suit } from '../coins/index.ts';
import { getRankIndex } from '../coins/index.ts';
...
export interface EvaluatedHand {
  ...
  readonly scoringCards: ReadonlyArray<Coin>;
  readonly kickers: ReadonlyArray<Coin>;
}
...
export const POKER_HANDS = {
  ...
  HIGH_CARD: { name: 'High Coin', rank: 1, baseChips: 5, baseMult: 1 },
} as const;
...
function getRankCounts(cards: ReadonlyArray<Coin>): ReadonlyArray<RankCount> {
...
function countSuits(cards: ReadonlyArray<Coin>): Map<Suit, number> {
...
function checkStraight(cards: ReadonlyArray<Coin>): ReadonlyArray<Coin> | null {
...
function checkRegularStraight(uniqueCards: ReadonlyArray<Coin>): ReadonlyArray<Coin> | null {
...
function checkAceLowStraight(uniqueCards: ReadonlyArray<Coin>): ReadonlyArray<Coin> | null {
...
function isConsecutive(cards: ReadonlyArray<Coin>): boolean {
...
function checkFlush(cards: ReadonlyArray<Coin>): ReadonlyArray<Coin> | null {
...
export function evaluatePokerHand(cards: ReadonlyArray<Coin>): EvaluatedHand {
...
function evaluateValidHand(cards: ReadonlyArray<Coin>): EvaluatedHand {
...
function evaluateNonStraightFlush(
  ...
  flushCards: ReadonlyArray<Coin> | null,
  straightCards: ReadonlyArray<Coin> | null
): EvaluatedHand {
