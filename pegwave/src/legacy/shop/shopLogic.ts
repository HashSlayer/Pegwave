...
import { addConsumable } from '../game/index.ts';
...
import type { SpectralCoin } from '../coins/index.ts';
import { createSpectralCoin } from '../coins/index.ts';
import type { AnyCoin } from '../coins/index.ts';
...
interface SelectingCardState extends BaseShopState {
  ...
  readonly pendingPack: {
    ...
    readonly cards: ReadonlyArray<AnyCoin>;
...
function createSpectralCardFromShopItem(item: SpectralItem): SpectralCoin | null {
  switch (item.effect.type) {
    case 'addFoil':
      return createSpectralCoin('foil', item.effect.count);
    case 'addHolographic':
      return createSpectralCoin('holographic', item.effect.count);
    case 'addPolychrome':
      return createSpectralCoin('polychrome', item.effect.count);
    case 'duplicateCard':
