...
- ✅ Consumables system (spectral, arcana, and planet plinkos)
- ✅ Glass card enhancement with breaking mechanic
- ✅ Planet plinkos (per-planet reverb/env ambience)
...
- [x] Fix spectral consumables to match legacy card spec
